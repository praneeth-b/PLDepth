...
def perform_pldepth_experiment(model_name, epochs, batch_size, seed, ranking_size, rankings_per_image, initial_lr,
    ...
    load_path = '/upb/departments/pc2/groups/hpc-prf-deepmde/praneeth/PLDepth/pldepth/weights/300821-1836471k_30ep_6r_model_rnd_sampling.h5'
    ...
    model.save('/scratch/hpc-prf-deepmde/praneeth/output/' + timestr + 'rnd_model_rnd_sampling.h5')
